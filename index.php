            ...
            <div class="container">
                <div class="header__navbar">
                    ...
                    <div class="header__navbar--menu">
                        ...
                        <button class="colortheme"><i class="fas fa-palette"></i></button>
                        ...
                        <div class="categorylist">
                            <ul>
                                <li class="listcommand">
                                    ...
                                    <ul>
                                        <li><a class="commandlink" href="./pages/music.html">clear</a></li>
                                ...
                                <li class="listcommand">
                                    ...
                                    <ul>
                                        <li><a class="commandlink" href="./pages/anime.html">anime</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
